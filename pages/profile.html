...
<body>
    ...
    <div class="container">
        ...
        <header>
            <div class="back">
                <a href="dashboard.html"><i class='bx bx-arrow-back'></a></i>
            </div>
            <div class="brandLogo">
                <figure><img src="logo.png" alt="logo" width="200px" height="160px"></figure>
            </div>
        </header>
        ...
        <section class="userProfile card">
            <div class="profile">
                <figure><img src="profile.jpg" alt="profile" width="250px" height="250px"></figure>
            </div>
        </section>
            ...
            <div class="contact_Info">
                ...
                <ul>
                    <li class="phone">
                        ...
                        <span class="info">+62 858-4725-5010</span>
                    </li>

                    <li class="address">
                        <h1 class="label">Address:</h1>
                        <span class="info"> Lebak Indah Street <br> South Jakarta, 12440</span>
                    </li>

                    <li class="email">
                        <h1 class="label">E-mail:</h1>
                        <span class="info">tazkyamr34@gmail.com</span>
                    </li>

                    <li class="site">
                        <h1 class="label">Site:</h1>
                        <span class="info">www.nails.com</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="basic_info">
                ...
                <ul>
                    <li class="birthday">
                        ...
                        <span class="info">Oct 24, 2005</span>
                    </li>
