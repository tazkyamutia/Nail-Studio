...
<head>
  ...
  <title>Nail  Art Tools - Nail Art Studio</title>
...
<body class="min-h-screen">
  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12 mt-12">
    <?php if (!empty($products)) : ?>
        ...
        <?php endforeach; ?>
    <?php else : ?>
        <p class="col-span-full text-center text-gray-500">No nail polish products available at this moment.</p>
    <?php endif; ?>
  </div>
  <!-- /PRODUCT GRID -->
